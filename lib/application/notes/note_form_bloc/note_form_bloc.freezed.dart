...
class _$_NoteFormBlocState implements _NoteFormBlocState {
  ...
  @override
  String toString() {
    return 'NoteFormState(note: $note, isEditing: $isEditing, isSaving: $isSaving, showErrorMessages: $showErrorMessages, saveFailureOrSuccessOption: $saveFailureOrSuccessOption)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, note, isEditing, isSaving,
...
abstract class _NoteFormBlocState implements NoteFormState {
